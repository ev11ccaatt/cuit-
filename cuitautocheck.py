...
s3 = s2[1]
print(str(s3)[64:69])
url4 = 'http://jszx-jxpt.cuit.edu.cn/Jxgl/Xs/netks/editSj.asp?UTp=Xs&Tx=33_1&ObjId=2020122031&Id='+str(s3)[64:69]
id = str(s3)[64:69]
data2 = {
'RsNum': '3',
'Id': id,
...
'ObjId': 'account',
'th_1': '21650',
'wtOR_1': '1\\|/%s\\|/%s\\|/%s\\|/\\|/\\|/\\|/\\|/\\|' % (sf1.encode('gb2312'),sf2.encode('gb2312'),sf3.encode('gb2312')),
'sF21650_1': '1',
'sF21650_2': sf1.encode('gb2312'),
'sF21650_3': sf2.encode('gb2312'),
'sF21650_4': sf3.encode('gb2312'),
'sF21650_5': '1',
'sF21650_6': '',
'sF21650_7': '',
'sF21650_8': '',
...
#proxies1={'http':'http://127.0.0.1:8080','https':'https://127.0.0.1:8080'}
r.headers.update(header2)  
#s=r.post(url='http://jszx-jxpt.cuit.edu.cn/Jxgl/Xs/netks/editSjRs.asp',data=data2,proxies=proxies1)
